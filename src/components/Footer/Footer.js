...
const Footer = () => {
  ...
  <a target="_blank" rel="noopener noreferrer" className="link dim gray dib h2 w2 br-100 mr3 pa2 bg-near-white ba b--black-10" href="https://twitter.com/chuks022" title="">
    <svg data-icon="twitter" viewBox="0 0 32 32" style={{fill:currentcolor}}>
      <title>twitter icon</title>
      <path d="M2 4 C6 8 10 12 15 11 A6 6 0 0 1 22 4 A6 6 0 0 1 26 6 A8 8 0 0 0 31 4 A8 8 0 0 1 28 8 A8 8 0 0 0 32 7 A8 8 0 0 1 28 11 A18 18 0 0 1 10 30 A18 18 0 0 1 0 27 A12 12 0 0 0 8 24 A8 8 0 0 1 3 20 A8 8 0 0 0 6 19.5 A8 8 0 0 1 0 12 A8 8 0 0 0 3 13 A8 8 0 0 1 2 4"></path>
    </svg>
  </a>
  <a target="_blank" rel="noopener noreferrer" className="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="https://github.com/amaechi-chuks" title="">
  ...
  <a target="_blank" rel="noopener noreferrer" className="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="https://medium.com/@amaechichuks2000" title="">
    <svg data-icon="medium" viewBox="0 0 32 32" style={{fill:currentcolor}}>
